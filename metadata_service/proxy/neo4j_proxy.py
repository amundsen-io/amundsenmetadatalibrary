...
class Neo4jProxy(BaseProxy):
    ...
    def _get_popular_tables_uris(self, num_entries: int, num_readers: int = 10) -> List[str]:
        """
    ...
    @timer_with_counter
    def get_popular_tables(self, *, num_entries: int, num_readers: int = 10) -> List[PopularTable]:
        """
