...
class Neo4jProxy(BaseProxy):
    ...
    def get_dashboard(self,
        ...
        WITH c, dg, d, description, last_exec, last_success_exec, t, owners, tags, recent_view_count, collect(query) as queries
        OPTIONAL MATCH (d)-[:HAS_QUERY]->(query:Query)-[:HAS_CHART]->(chart:Chart)
        WITH c, dg, d, description, last_exec, last_success_exec, t, owners, tags, recent_view_count, queries, collect(chart) as charts
