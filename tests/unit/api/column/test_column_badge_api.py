...
class TestColumnBadgeAPI(BasicTestCase):
    ...
    def test_block_bad_badge_name(self) -> None:
        ...
        response = self.app.test_client().put(f'/table/{TABLE_NAME}/column/{COLUMN_NAME}/badge/{BADGE_NAME}?category=table_status')
    ...
    def test_block_badge_missing_category(self) -> None:
        ...
        response = self.app.test_client().put(f'/table/{TABLE_NAME}/column/{COLUMN_NAME}/badge/{BADGE_NAME}')
